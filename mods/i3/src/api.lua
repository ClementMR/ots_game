...
IMPORT("get_player_by_name", "init_hud_notif")
IMPORT("gmatch", "split", "S", "err", "fmt", "reg_items")
...
function i3.add_waypoint(name, def)
	return err "i3.add_waypoint: waypoints are disabled"
end

function i3.remove_waypoint(player_name, name)
	return err "i3.remove_waypoint: waypoints are disabled"
end
