...
local node_tiles = core.settings:get_bool("wieldview_node_tiles") or false
local enable_wieldview = core.settings:get_bool("enable_wieldview") or true

-- https://github.com/core/core/blob/9fc018ded10225589d2559d24a5db739e891fb31/doc/lua_api.txt#L453-L462
