...
armor:register_armor("3d_armor:chestplate_admin", {
	...
	armor_groups = {immortal=1},
	groups = {armor_torso=1, armor_use=0, not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
...
armor:register_armor("3d_armor:leggings_admin", {
	...
	armor_groups = {immortal=1},
	groups = {armor_legs=1, armor_use=0, not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
...
armor:register_armor("3d_armor:boots_admin", {
	...
	armor_groups = {immortal=1},
	groups = {armor_feet=1, armor_use=0, not_in_creative_inventory=1},
	on_drop = function(itemstack, dropper, pos)
		return
	end,
})
